          ...
          <div className="mt-12 grid gap-12 md:grid-cols-2">
            ...
            <form className="space-y-6">
              <div>
                ...
                <input
                  type="text"
                  className="w-full mt-2 p-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-600 text-lg"
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-lg font-semibold text-sm text-white bg-gradient-to-r from-yellow-500 via-yellow-600 to-black hover:opacity-90 transition"
              >
                Send Message
              </button>
            </form>
              ...
              {[
                {
                  ...
                  text: "123 Legal Street, Suite 100, New York, NY",
                },
                {
                  icon: "📞",
                  title: "Phone",
                ...
                },
                {
                  icon: "✉️",
                  title: "Email",
                  text: "contact@lawfirm.com",
                },
              ].map((item, index) => (
                <div key={index} className="flex items-start">
                  <div className="w-12 h-12 bg-gradient-to-r from-yellow-500 via-yellow-600 to-black text-white flex items-center justify-center rounded-lg text-2xl">
                    {item.icon}
                  </div>
                  <div className="ml-5">
